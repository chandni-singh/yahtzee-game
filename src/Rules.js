...
const fourOfKind = new SumDistro({ count: 4, description : "Sum of all dice if 4 are the same" });

// full house scores as flat 25
const fullHouse = new FullHouse({ score: 25, description : "3 of a kind/2 of another, score 25"});
